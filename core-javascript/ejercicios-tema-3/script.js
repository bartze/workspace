...
const pregunta1 = prompt('¿Cuál es la mejor serie de Star Wars?').trim().toLowerCase();
const pregunta2 = prompt('¿Qué serie de Star Wars es una obra maestra?').trim().toLowerCase();
const respuesta1 = 'the bad batch';
const respuesta2 = 'the mandalorian';
