...
let frase = "Cuando Fernando Séptimo llevaba pantalón"
const cambiarVocales = (palabras, vocal) => {
    return palabras.replace(/[aeiou]/gi, vocal);
};
let nuevaFraseA = cambiarVocales(frase, 'a');
console.log(nuevaFraseA);
let nuevaFraseE = cambiarVocales(frase, 'e');
console.log(nuevaFraseE);
let nuevaFraseI = cambiarVocales(frase, 'i');
console.log(nuevaFraseI);
let nuevaFraseO = cambiarVocales(frase, 'o');
console.log(nuevaFraseO);
let nuevaFraseU = cambiarVocales(frase, 'u');
